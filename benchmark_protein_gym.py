...
def simulate_active_learning(
    ...
    for strategy in strategies:
        ...
        # Start round 1, adds round record to db
        ...
        for round_num in range(2, n_rounds + 1):
            ...
            # Add proposed variants to database
            for proposed in proposed_variants:
                controller.data_manager.add_variant(proposed.variant)
            ...
            if round_num > 2:
                previous_variants = results[strategy]["round_variants"][-2]
